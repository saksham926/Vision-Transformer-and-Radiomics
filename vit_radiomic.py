...
#inception_pred.compile(optimizer = tf.keras.optimizers.RMSprop(learning_rate=0.0002), loss=tf.keras.losses.CategoricalCrossentropy(from_logits = False) , metrics=['accuracy'])
    ...
    print("val cat:",len(val_cat_files))
    ...
    print("train cat:",len(train_cat_files))
    ...
    plt.savefig("/home/ssharma8/manas_user/confusion_matrix vitradio"+str(model_counter)+".png")
    plt.show()
    ...
    thresh ={}    
    roc_auc = dict()
    classes=['Metaplastic','Koilocytotic','Dyskeratotic', 'Parabasal', 'Superficial Intermediate']
    n_class = 5
    ...
    plt.savefig("/home/ssharma8/manas_user/ROC_AUC_vitradio"+str(model_counter)+".png")
    plt.show()
    ...
    filename = '/home/ssharma8/manas_user/vitradio_model_'+str(model_counter)+'.sav'
