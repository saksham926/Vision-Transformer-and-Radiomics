...
#     # Define the RandomCutout function with desired parameters
#     random_cutout = RandomCutout(height_factor=0.4, width_factor=0.4)

#     # Apply RandomCutout to each image in the numpy array
#     X_train_cutout = [random_cutout(image) for image in X_train]

#     # Convert the list of images back to a numpy array
#     X_train_cutout = np.array(X_train_cutout)

#     return X_train_cutout, y_train
